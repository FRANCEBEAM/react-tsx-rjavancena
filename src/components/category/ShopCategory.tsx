  ...
  return (
    <>
      <div className="w-full h-full max-w-[1200px] m-auto my-20">
        ...
        <div className="my-20 gap-4 grid grid-cols-4">
          {categoryList.map((item, index) => (
            <div className="stats shadow cursor-pointer hover:bg-base-200 transition-all ease-in-out duration-300" key={index}>
              <div className="stat">
                <div className="stat-title font-bold text-sm">
                  {item.category}:
                </div>
                <div className="flex">
                  <div className="stats-desc text-xs">
                    {item.sub &&
